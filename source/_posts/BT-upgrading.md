...
photos: 2018/09/26/BT-upgrading/0.png
---
...
**[MobaXterm_Personal_10.2.exe](BT-upgrading/https://www.lanzous.com/i1ytvvg)**

使用神器 ssh 登入你的服务器
![1](BT-upgrading/1.png)

登入后你就会发现 这个软件居然有目录
![2](BT-upgrading/2.png)
...
![3](BT-upgrading/3.png)

修改内容：
注释该行`raise web.seeother('/vpro');`
将这个跳转页面注释了
![4](BT-upgrading/4.png)
...
删除了不用的东西
为我们的付费页面改个名
![6](BT-upgrading/6.png)

修改完成 我们重启一下我们的宝塔
`service bt restart`
![7](BT-upgrading/7.png)

### 修改完成
我们欣赏一下我们的修改结果
![8](BT-upgrading/8.png)
